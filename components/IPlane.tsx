...
export default function IPlane() {
  ...
  return (
    <>
      <div className="absolute left-0 top-0 bottom-0 w-64 pointer-events-auto z-50 flex items-center">
        <div 
          className="bg-black/90 backdrop-blur-sm p-6 flex flex-col relative w-full"
