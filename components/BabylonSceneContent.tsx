    ...
    try {
      ...
      const setupLighting = (preset: string, enabled: boolean, ambientValue?: number) => {
        ...
        if (glbLightCount === 0) {
          ...
          const baseAmbient = 3.5; // BRIGHTER - let the cave shine with golden warmth
          ...
          ambientLight.diffuse = new Color3(0.92, 0.87, 0.75); // WARM GOLDEN glow
          ambientLight.groundColor = new Color3(0.25, 0.22, 0.18); // Warm ground reflection
